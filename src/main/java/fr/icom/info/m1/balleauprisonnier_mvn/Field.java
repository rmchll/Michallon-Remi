	...
	public Field(Scene scene, int w, int h)
	{
		...
		new AnimationTimer()
		{
			public void handle(long currentNanoTime)
			{
				...
				{
					if (joueurs[i].side=="top" && input.contains("LEFT"))
					{
						joueurs[i].moveLeft();
					}
					if (joueurs[i].side=="top" && input.contains("RIGHT"))
					{
						joueurs[i].moveRight();
					}
					if (joueurs[i].side=="top" && input.contains("UP"))
					{
						joueurs[i].turnLeft();
					}
					if (joueurs[i].side=="top" && input.contains("DOWN"))
					{
						joueurs[i].turnRight();
					}

					if (joueurs[i].side=="top" && input.contains("ENTER"))
					{
						joueurs[i].shoot();
					}
